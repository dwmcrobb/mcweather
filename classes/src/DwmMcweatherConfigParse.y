...
%token ADDRESS ADDRESSES ALLOWEDCLIENTS CACHE FACILITY KEYDIRECTORY
%token LATITUDE LEVEL LOCATION LOGLOCATIONS LONGITUDE PORT SERVICE
%token STATIONS STORE SYSLOG WEATHER
